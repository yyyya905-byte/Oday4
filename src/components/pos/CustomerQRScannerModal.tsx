        ...
        <div className="p-4 bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">
              {t('scanCustomerQR')} / بطاقة العضوية
            </h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2.5 bg-amber-500 hover:bg-amber-600 active:scale-95 text-white font-bold text-xs rounded-xl shadow-xs shrink-0"
            >
              بحث
            </button>
          </div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {customers.map(c => (
                <button
                  ...
                  className="px-2.5 py-1 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-amber-50 dark:hover:bg-amber-950/40 text-[11px] font-medium text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 flex items-center gap-1"
                >
                  <span>{c.name}</span>
          ...
          {foundCustomer && (
            <div className="p-4 bg-gradient-to-br from-amber-500/10 to-amber-500/5 dark:from-amber-950/40 dark:to-slate-800/40 border border-amber-500/30 rounded-2xl animate-in fade-in">
              ...
              <button
                ...
                className="w-full mt-3.5 py-2.5 bg-amber-500 hover:bg-amber-600 active:scale-98 text-white font-bold text-xs rounded-xl shadow-md shadow-amber-500/20 flex items-center justify-center gap-2 transition-all"
              >
